...
pub use crate::{
    ...
    profile::{
        ...
        ClaudeCompatibleProviderKind, MinimaxProvider, MinimaxProviderConfig, MoonshotProvider,
        MoonshotProviderConfig, OllamaProvider, OllamaProviderConfig, OpenRouterProvider,
        OpenRouterProviderConfig, VercelProvider, VercelProviderConfig, VertexProvider,
        VertexProviderConfig, ZaiProvider, ZaiProviderConfig, CLAUDE_COMPATIBLE_PROVIDER_IDS,
    },
