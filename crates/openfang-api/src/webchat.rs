...
const WEBCHAT_HTML: &str = concat!(
    ...
    "\n",
    include_str!("../static/js/api-v1.js"),
    "\n",
    ...
    "\n",
    include_str!("../static/js/pages/hitl.js"),
    "\n",
    include_str!("../static/js/pages/runs.js"),
    "\n",
    include_str!("../static/js/pages/dispatches.js"),
    "\n",
    include_str!("../static/js/pages/tasks.js"),
    "\n",
    include_str!("../static/js/pages/triggers.js"),
    "\n",
    include_str!("../static/js/pages/schedules.js"),
    "\n",
    include_str!("../static/js/pages/events.js"),
    "\n",
    include_str!("../static/js/pages/comms.js"),
    "\n",
    include_str!("../static/js/pages/runtime.js"),
    "\n",
    include_str!("../static/js/pages/looper.js"),
    "\n",
    include_str!("../static/js/pages/packs.js"),
    "\n",
    include_str!("../static/js/pages/artifacts.js"),
    "\n",
    include_str!("../static/js/pages/documents.js"),
    "\n",
    include_str!("../static/js/pages/integrations.js"),
    "\n</script>\n",
